...
public class Loge {
  private static final boolean LOG_STATUS = BuildConfig.DEBUG;
  private static final String LOG_TAG = "JUNYI";
  private static String tag = "JUNYI";
  ...
  public static void w(Throwable error) {
    if (LOG_STATUS) {
      tag = l.getFunctionName();
      Log.w(LOG_TAG, "[" + tag + "] Exception: " + Log.getStackTraceString(error));
    }
  }
  ...
  public static void e(Throwable error) {
    if (LOG_STATUS) {
      tag = l.getFunctionName();
      Log.e(LOG_TAG, "[" + tag + "] Exception: " + Log.getStackTraceString(error));
    }
  }
